...
SELECT customer.cust_ID, customer.customer_name FROM customer
WHERE (customer.customer_street, customer.customer_city) IN
(SELECT customer.customer_street, customer.customer_city
FROM customer WHERE customer.cust_ID = '12345')
EXCEPT
SELECT customer.cust_ID, customer.customer_name FROM customer
WHERE customer.cust_ID = '12345'
ORDER BY cust_ID;